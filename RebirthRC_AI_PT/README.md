...
- **Payload Integration**: รองรับการโจมตีด้วย Payloads จำนวนมากจากไฟล์ (SQLi, XSS, RCE, Fuzz)
- **Steganography Payload Delivery**: สร้างและเตรียม Payload ที่ซ่อนในไฟล์ภาพสำหรับ Social Engineering
...
6. **Social Engineering** – (เมื่อมีโอกาส) สร้างและส่ง Steganography Payload เพื่อเจาะ Client-side
